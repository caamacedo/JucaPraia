...
/*Exercício 5 Inserir os seguintes equipamentos:
...
(idCliente, idFuncionario, dataHoraRetirada,dataHoraDevolucao,valorAPagar, valorPago, pago, formaPagamento, qtVezes)
VALUES
('15','1','2024-12-27 13:00:00','24-12-27 16:00','6.00','6.00','1','dinheiro',NULL)
...
FROM cliente
WHERE cidade IN
 ('Santos','Bertioga','Guarujá','Cubatão','São Vicente','Praia Grande','Monguaguá','Itanhaém','Peruíbe')
